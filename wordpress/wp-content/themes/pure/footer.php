	<div id="footer">			
		...
		<div class="secondary clearfix">
			...
			<div class="right"><?php if($footer_right){echo($footer_right);} else{ ?><?php _e('Theme by', 'themetrust'); ?> <a href="http://themetrust.com" title="Theme Trust"><strong>Theme Trust</strong></a><?php }; ?></div>
