...
<?php
	...
	<div class="column col2">
		...
		<p><?php excerpt(); ?></p>
		<a class="more-link" title="<?php printf( esc_attr__( 'Permalink to %s', 'colabsthemes' ), the_title_attribute( 'echo=0' ) ); ?>" href="<?php the_permalink();?>"><?php _e('Read Mawr','colabsthemes');?>&rarr;</a>
	</div>
