...
$ttrust_theme_name = "Pure";
$ttrust_theme_version = "1.1.5";
$ttrust_suggested_img_size = "580px x 270px";
		...
		<form id="optionsForm" method="post" action="options.php">			
		    ...
		    <div class="optionsContainer clearfix">	
				...
				<div id="option2" class="optionContent">
					<!-- Color -->
					<div class="subOption">
						<h3 class="colorHeading">Color</h3>													
					
						<div class="itemRow clearfix divided">
							<span class="inlineItem clearfix"><label class="medium"><strong><?php _e('Accent:', 'themetrust'); ?></strong></label> <input class="colorField" name="ttrust_options[ttrust_color_accent]" id="colorMenuHover"  type="text" size=7 value="<?php if (isset($ttrust_options['ttrust_color_accent'])) { echo $ttrust_options['ttrust_color_accent']; } ?>" /> </span>							
						</div>											
						<div class="itemRow clearfix divided">
							<span class="inlineItem clearfix"><label class="medium"><strong><?php _e('Links:', 'themetrust'); ?></strong></label> <input class="colorField" name="ttrust_options[ttrust_color_body_link]" id="colorBodyLink"  type="text" size=7 value="<?php if (isset($ttrust_options['ttrust_color_body_link'])) { echo $ttrust_options['ttrust_color_body_link']; } ?>" /> </span>
							<span class="inlineItem clearfix"><label class="small"><?php _e('hover:', 'themetrust'); ?></label> <input class="colorField" name="ttrust_options[ttrust_color_body_link_hover]" id="colorBodyLinkHover"  type="text" size=7 value="<?php if (isset($ttrust_options['ttrust_color_body_link_hover'])) { echo $ttrust_options['ttrust_color_body_link_hover']; } ?>" /> </span>
						</div>
			...
			<div id="option4" class="optionContent">
				...
				<div class="subOption">
					...
					<p class="instructions"><?php _e('Enter a message. This will appear on the home page under the header.', 'themetrust'); ?></p>
				</div>
				...
				<div class="subOption clearfix">
					...
					<p class="instructions"><?php _e('Adjust the speed of the home page slideshow. Move the slider to the far left to disable auto-playing.', 'themetrust'); ?><br/><?php _e('Suggested image size:', 'themetrust'); ?> <strong><?php echo $ttrust_suggested_img_size; ?></strong></p>										
				</div>
